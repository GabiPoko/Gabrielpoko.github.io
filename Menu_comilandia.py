...
def ingresar():
    ...
    if acceso:
        ...
        def bebidas():
            ...
            ventanita.config(bg="LightGreen")
            ventanita.iconbitmap('trago.ico.ico')
            ...
            # Crear el menú "Opciones"
            menu_opciones = tk.Menu(menu_bar, tearoff=0)
            menu_bar.add_cascade(label="Volver al menú", menu=menu_opciones)
            menu_opciones.add_command(label="Salir", command=ventanita.destroy)
